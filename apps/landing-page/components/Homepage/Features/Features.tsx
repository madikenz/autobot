...
const features = [
  ...
  },
  {
    ...
    content: 'Invite your teammates to work on your autobots with you',
  },
  {
    Icon: ConditionIcon,
    title: 'Link to sub typebots',
    content: 'Reuse your autobots in different parent bots.',
  },
  {
    Icon: CalculatorIcon,
    title: 'Custom code',
  ...
  },
  {
    Icon: ShareIcon,
    title: 'Custom domain',
    content: 'Connect your autobot to the custom URL of your choice',
  },
  {
    Icon: FolderIcon,
    title: 'Folder management',
    content:
      'Organize your autobots in specific folders to keep it clean and work with multiple clients',
  },
]
      ...
      >
        <VStack>
          ...
          <Text
            ...
            data-aos="fade"
          >
            Autobot makes form building easy and comes with powerful features
          </Text>
        </VStack>
